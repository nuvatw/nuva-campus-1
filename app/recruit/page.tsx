...
const SupportFormModal = dynamic(
  () => import('@/app/components/shared/SupportFormModal').then(mod => ({ default: mod.SupportFormModal })),
  { ssr: false }
);
    ...
    <>
      ...
      <div className={`min-h-screen bg-bg-primary transition-opacity duration-300 ${
        ...
        <section className="relative py-20 px-6 overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-b from-bg-primary via-primary-50/20 to-bg-primary" />
          <FadeIn>

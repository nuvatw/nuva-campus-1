...
import type { Supporter, SupportType } from '@/app/types/supporter';
    ...
    return (
      <section className="py-16 bg-gradient-to-b from-bg-primary to-bg-secondary/50">
        <div className="max-w-4xl mx-auto text-center px-6">
          ...
          <div className="bg-bg-card rounded-2xl p-12 border border-border shadow-md">
      ...
      {showNewCard && newCardAnimation && (
        <div className="fixed inset-0 z-50 pointer-events-none">
          ...
          <div className="absolute animate-fly-to-wall">
            <div className={`
              w-72 bg-bg-card rounded-2xl p-4 shadow-elevation-4 border-2
              ${newCardAnimation.type === 'help' ? 'border-primary' : 'border-accent'}
            `}>
              <div className="flex items-center gap-3">
                <div className={`
                  w-12 h-12 rounded-full flex items-center justify-center text-white font-bold text-lg
                  ${newCardAnimation.type === 'help' ? 'bg-gradient-to-br from-primary to-primary-dark' : 'bg-gradient-to-br from-accent to-amber-600'}
                `}>
      ...
      <div className="max-w-6xl mx-auto px-6">
        <FadeIn>
          <div className="text-center mb-8">
            <h2 className="text-3xl font-bold text-text-primary mb-3 font-display">應援牆</h2>

  ...
  return (
    <section className="py-12 bg-bg-secondary/50">
      <div className="max-w-4xl mx-auto px-6">
        {/* Title */}
        <FadeIn>
          <h2 className="text-center text-3xl md:text-4xl font-bold text-text-primary mb-4 font-display">
        ...
        {/* Daily schedule */}
        <StaggerChildren staggerDelay={0.08} className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-10">
          <StaggerChildren.Item>
            <div className="bg-bg-card rounded-xl p-5 text-center border border-border shadow-elevation-1">

 ...
 *
 * 架構：
 * - Server-side：React `cache()` 包裝，同一請求自動 dedupe
 * - Client-side：經由 CacheManager 做本地快取
 * - SWR fetcher：供 useSWR 直接使用的通用 fetcher
 */
...
// =============================================
// Server-side Fetchers（React cache — 同一請求 dedupe）
// =============================================
...
// =============================================
// Client-side Fetchers（CacheManager — 本地快取 + TTL）
// =============================================
...
// =============================================
// SWR Fetcher（供 useSWR 的通用 HTTP fetcher）
// =============================================

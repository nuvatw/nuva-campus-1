...
async function fetchEventsWithStats(): Promise<EventStats[]> {
  ...
  return events.map(e => ({ ...e, notificationPendingCount: 0 }));
}
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <FadeIn>
          <div className="flex items-center justify-between mb-8">
            <div>
              <h1 className="text-2xl font-display font-semibold text-text-primary">守護者總覽</h1>
        ...
        <FadeIn delay={0.05}>
          {statsLoading ? (
            <SkeletonStatsGrid count={4} columns={4} />
          ) : stats ? (
        ...
        {/* Event List with expandable rows */}
        <FadeIn delay={0.1}>
          <div className="card">
                ...
                {events.map((event, idx) => (
                  ...
                  >
                    <button
                      ...
                      className="w-full text-left p-4 bg-bg-secondary rounded-lg hover:bg-bg-primary transition-colors group"
                    >
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-6">
                          <div className="text-center">
                            ...
                            <p className="font-semibold tabular-nums">{event.registrationCount}</p>
                          </div>
                          <div className="text-center">
                            <p className="text-xs text-text-muted">報到</p>
                            <p className="font-semibold text-primary tabular-nums">{event.checkedInCount}</p>
                          </div>
                          <div className="text-center">
        ...
        {/* Quick Actions */}
        <StaggerChildren className="mt-8 grid grid-cols-2 md:grid-cols-3 gap-4">
          {[
            ...
            <StaggerChildren.Item key={href}>
              <Link href={href} className="card card-interactive text-center py-6 block">

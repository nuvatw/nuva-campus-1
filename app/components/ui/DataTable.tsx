        ...
        <div className="mb-4">
          <div className="relative">
            <input
              ...
              className="w-full sm:w-64 pl-10 pr-4 py-2 border border-border rounded-xl bg-bg-card text-text-primary placeholder-text-muted focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary"
            />
            <svg
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <select
                ...
                className="px-2 py-1 border border-border rounded-xl bg-bg-card text-text-primary text-sm focus:outline-none focus:ring-2 focus:ring-primary/20"
              >
            ...
            <div className="flex items-center gap-1">
              <button
                ...
                className="p-2 min-w-[44px] min-h-[44px] flex items-center justify-center rounded-xl text-text-muted hover:text-text-primary hover:bg-bg-secondary disabled:opacity-50 disabled:cursor-not-allowed"
                aria-label="第一頁"
              >
              ...
              <span className="px-3 text-sm text-text-primary" aria-live="polite" aria-atomic="true">

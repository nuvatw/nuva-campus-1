...
export default function YouTubeEmbed({ videoId, title = '工作坊影片' }: YouTubeEmbedProps) {
  ...
  return (
    <div className="bg-bg-card rounded-xl p-4 sm:p-6 shadow-sm border border-border">
      <h3 className="text-base sm:text-lg font-bold text-text-primary mb-4">
        工作坊回放
      </h3>

      {/* 響應式 16:9 影片容器 */}
      <div className="relative w-full pt-[56.25%] bg-bg-secondary rounded-xl overflow-hidden">
        <iframe
